  ...
  },
  {
    ...
    responsibility: [
      ...
      [
        ...
        { text: " for cross-platform mobile development." },
      ],
      [
        { text: "Built " },
        { text: "heavy browser-based NLE apps", bold: true },
        { text: " such as an " },
        { text: "in-browser video editor", bold: true },
        { text: "." },
      ],
      [
        { text: "Learnt " },
        { text: "optimisation and WASM", bold: true },
        { text: " for " },
        { text: "WebKit-based video editors", bold: true },
        { text: "." },
      ],
    ],
    techstacks: ["React Native", "WASM", "WebKit", "Video Editing"],
  },
  {
    role: "Software Engineer",
    ...
    responsibility: [
      ...
      [
        { text: "Building " },
        { text: "cross-platform apps for Avenue users and partners", bold: true },
        { text: " using " },
        { text: "React Native", bold: true },
        { text: "." },
      ],
      [
        { text: "Supporting and fixing " },
        { text: "payments in the Capacitor app", bold: true },
        { text: "." },
      ],
    ],
    techstacks: [
